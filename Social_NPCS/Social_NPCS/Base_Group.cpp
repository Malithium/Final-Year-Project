...
/*!
@file
@brief base class for the NPC group classes
...
void Base_Group::simulateConversation(SDL_Renderer* renderer, bool time, std::string boredomLevel, TTF_Font* font) {}
...
void Base_Group::setSpeaker(std::string boredomLevel) {}